...
/* themes/contrib/tailpine/templates/content/node.html.twig */
class __TwigTemplate_cfc730758a44c94151cd9ff415837151 extends Template
{
...
($context["view_mode"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass(($context["view_mode"] ?? null)))) : (""))];
        // line 73
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("tailpine/node"), "html", null, true);
        yield "
<article";
        // line 74
...
";
    ...
    {
        return "themes/contrib/tailpine/templates/content/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/tailpine/templates/content/node.html.twig", "/var/www/html/web/themes/contrib/tailpine/templates/content/node.html.twig");
    }
